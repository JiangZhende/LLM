...
# hf download --repo-type dataset TigerResearch/pretrain_zh --local-dir datasets/pretrain/TigerResearch/pretrain_zh
...
huggingface-cli download --repo-type dataset TigerResearch/sft_zh --local-dir datasets/sft/TigerResearch/sft_zh
