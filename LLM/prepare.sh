...
# pretrain
huggingface-cli download --repo-type dataset pleisto/wikipedia-cn-20230720-filtered --local-dir datasets/pretrain/pleisto/wikipedia-cn-20230720-filtered
huggingface-cli download --repo-type dataset xuqinyang/BaiduBaike-5.63M --local-dir datasets/pretrain/xuqinyang/BaiduBaike-5.63M
huggingface-cli download --repo-type dataset wangrui6/Zhihu-KOL --local-dir datasets/pretrain/wangrui6/Zhihu-KOL
huggingface-cli download --repo-type dataset wdndev/webnovel-chinese --local-dir datasets/pretrain/wdndev/webnovel-chinese
huggingface-cli download --repo-type dataset TigerResearch/pretrain_zh --local-dir datasets/pretrain/TigerResearch/pretrain_zh
